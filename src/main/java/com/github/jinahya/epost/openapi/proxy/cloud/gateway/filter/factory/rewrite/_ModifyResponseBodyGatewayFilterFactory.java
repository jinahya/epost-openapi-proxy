...
package com.github.jinahya.epost.openapi.proxy.cloud.gateway.filter.factory.rewrite;
...
@Component
// https://github.com/spring-cloud/spring-cloud-gateway/blob/main/spring-cloud-gateway-server/src/main/java/org/springframework/cloud/gateway/filter/factory/rewrite/ModifyResponseBodyGatewayFilterFactory.java
public class _ModifyResponseBodyGatewayFilterFactory
        extends AbstractGatewayFilterFactory<_ModifyResponseBodyGatewayFilterFactory.Config> {
    ...
    public _ModifyResponseBodyGatewayFilterFactory(List<HttpMessageReader<?>> messageReaders,
    ...
    protected class ModifiedServerHttpResponse
        ...
        public Mono<Void> writeWith(Publisher<? extends DataBuffer> body) {
            ...
            httpHeaders.add(HttpHeaders.CONTENT_TYPE,
                            Optional.ofNullable(config.newContentType).orElse(originalResponseContentType));
